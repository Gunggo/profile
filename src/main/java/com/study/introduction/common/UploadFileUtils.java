...
//    }
    ...
    // 썸네일 이미지 생성
    public static String makeThumbnail(String uploadRootPath, String fileName) throws Exception {
        ...
        // 썸네일 업로드 경로
        String fullPath = uploadRootPath + File.separator + thumbnailImgName;
        // 썸네일 파일 객체생성
